...
<head>
  ...
  <style>
    ...
    .bgimg {
      background-image: url('https://cdn.alittledelightful.com/wp-content/uploads/2025/02/exterior-colour-scheme-terracotta-roof-house-colors.webp');
      min-height: 100%;
...
<body>
  <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
    ...
    <div class="w3-display-middle w3-center">
      <iframe src="https://tlceventsandweddings.com/wp-content/uploads/2022/12/hot-asian-woman.jpeg?w=50%"
              width="500"
              height="520"
    ...
    <div class="w3-display-bottomleft w3-padding-small transparent-background outlined-text">
      ...
      <p><b>I, Futurist2099, thank you, Theo and Beron!</p>
    </div>
  </div>
</body>
</html>
